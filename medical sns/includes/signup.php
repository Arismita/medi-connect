  ...
  if(isset($_GET['step']) === true && empty($_GET['step']) === false){
  	if(isset($_POST['next'])){
  		...
  		if(!empty($username)){
  			...
  			$error= "please enter your preferred username";
  		}
  	}
  	?>
	...
	<?php if($_GET['step'] == '2') { ?>
	 	<div class='lets-wrapper'>
			<div class='step-letsgo'>
				...
				<p>MediConnect is a constantly updating stream of medical related important news, conversations, discussions and more--all tailored just for you.</p>
				<br/>
				<p>
					Tell us about all the stuff you want to know and we'll help you get set up.
				</p>
				<span>
