$(function(){
	$(document).on('click','.like-btn', function(){
		...
		$.post('http://localhost/medical%20sns/core/ajax/like.php', {like:post_id, user_id:user_id}, function(){
			counter.show();
	...
	$(document).on('click','.unlike-btn', function(){
		...
		$.post('http://localhost/medical%20sns/core/ajax/like.php', {unlike:post_id, user_id:user_id}, function(){
			counter.show();
