<?php
	class Message extends User{
		...
		public function notification($user_id){
			$stmt = $this->pdo->prepare("
				SELECT * FROM `notification` N 
						 ...
						 LEFT JOIN `posts` P ON N.`target` = P.`postID`
		...
		public function sendNotification($get_id, $user_id, $target, $type){
			...
			// $stmt = $this->pdo->prepare("INSERT INTO `notification` (`notificationFor`, `notificationFrom`, `target`, `type`, `time`) VALUES (:get_id, :user_id, :target, :type, date('Y-m-d H:i:s'))");
